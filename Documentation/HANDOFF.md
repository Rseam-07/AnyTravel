...
- 主仓库（本会话工作目录）：`/Users/conrad/Documents/AnyTravel`，HEAD `a491855`（功能提交 `518c0ce` + 文档微调）
- Codex 侧工作副本：`/Users/conrad/Documents/ChatGPT/AnyTravel`（**已同步**，HEAD `9dcd418`，文件树与主仓库一致；注意两棵树的 `.git` 是各自独立的仓库，提交哈希不同）
