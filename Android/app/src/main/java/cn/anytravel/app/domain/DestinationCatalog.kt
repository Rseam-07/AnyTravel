...
object DestinationCatalog {
    private val suzhou = DestinationPack(
        ...
        places = listOf(
            ...
            place("山塘街", "姑苏区山塘街", 31.3182, 120.5981, TripInterest.NIGHT, "黄昏以后沿河灯火渐起，适合作为不赶时间的夜间散步。", 6, 90),
            place("金鸡湖景区", "苏州工业园区星港街", 31.3173, 120.7045, TripInterest.FAMILY, "开阔湖岸适合亲子散步，也为密集的古城行程留一段呼吸。", 7, 120),
            place("网师园", "姑苏区阔家头巷11号", 31.2980, 120.6298, TripInterest.CULTURE, "小园尺度亲近，宅与园的转折尤其适合慢慢体会。", 8, 105)
        ),
